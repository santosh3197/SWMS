...
{    
    ...
    // checking empty fields
       if( empty($date1) ||empty($city) || empty($source) || empty($area) || empty($weight) || empty($bookmark)) {
        ...
        //updating the table
        $result = mysqli_query($mysqli, "UPDATE collect SET date1='$date1',city='$city',source='$source',area='$area',weight='$weight',bookmark='$bookmark' WHERE id=$id");
...
$result = mysqli_query($mysqli, "SELECT * FROM collect WHERE id=$id");
...
<div class="row">
  <div class="input-field col s12">
    ...
    <input id="loc" type="text" name="area" class="validate">
...
<div class="row">
  <div class="input-field col s12">
    ...
    <input id="weight" type="text" name="weight" class="validate">
  ...
  <div class="row">
        <div class="row">
          <div class="input-field col s12">
            ...
            <textarea id="textarea1" name="bookmark" class="materialize-textarea"></textarea>
            <label for="textarea1">Any Bookmarks</label>
          </div>
        </div>
    </div>
<button name="submit"  class="btn waves-effect waves-light btn-large" >Submit
