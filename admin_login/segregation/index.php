...
$result = mysqli_query($mysqli, "SELECT * FROM segregate ORDER BY id ASC"); // using mysqli_query instead
?>
...
<body>
<div class="add">
    <a href="segregation.htm" class="waves-effect waves-light btn hoverable"><i class="material-icons left">add</i>Add New Data</a>
</div>
