		...
		<?php
			if(isset($_POST['submit_btn']))
			{
				...
				if($password==$cpassword)
				{
					...
					$query= "select * from stafftable WHERE username='$username'";
					...
					else
					{
						...
						$query= "insert into stafftable values('','$firstname','$lastname','$username','$password','$email','$phone','$gender','$target_file')";
						$query_run = mysqli_query($con,$query);
